...
const outputPath = path.join(root, "output", "kdp", "o-que-ainda-doi-ecos-da-harmonia-paperback-interior.html");
...
<head>
  <meta charset="utf-8">
  <title>O Que Ainda Dói — Ecos da Harmonia — Interior Paperback</title>
  <style>
    @page {
      size: 6in 9in;
