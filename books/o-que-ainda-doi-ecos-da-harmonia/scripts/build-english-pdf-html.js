...
const outputPath = path.join(root, "output", "pdf", "what-still-hurts", "what-still-hurts-echoes-of-harmony.html");
...
<head>
  <meta charset="utf-8">
  <title>What Still Hurts — Echoes of Harmony</title>
  <style>
    @page {
      size: 6in 9in;
...
<body>
  <section class="cover">
    <img src="${coverUrl}" alt="Cover of What Still Hurts — Echoes of Harmony">
  </section>
